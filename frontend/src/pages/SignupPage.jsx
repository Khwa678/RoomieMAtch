...
import { Users, Mail, Lock, User, Sparkles, AlertCircle, Info } from 'lucide-react';
    ...
    <div className="min-h-[85vh] flex items-center justify-center px-4 sm:px-6 lg:px-8 py-12">
      <div className="w-full max-w-md space-y-8 glass-panel p-8 rounded-3xl border border-slate-800 shadow-2xl relative">
        <div className="text-center space-y-2">
          ...
          <p className="text-xs text-slate-400">Join RoomieMatch to find verified, compatible roommates</p>
        </div>
        ...
        <div className="flex flex-col items-center justify-center space-y-2 py-2">
          <div id="googleSignUpBtn" className="flex justify-center min-h-[44px]"></div>
          <button
            type="button"
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center text-xs uppercase">
            <span className="bg-slate-900 px-3 text-slate-500">Or register with Email & Password</span>
          </div>
        </div>
